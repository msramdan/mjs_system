<!DOCTYPE html>
 <html><head>
    ...
    <hr>
    <h4 style="text-align: center;">SALES ORDER</h4>
          ...
          <td style="width: 50%;border-right: 1px solid black !important; ">
            ...
            <td style="width: 50%;">
                <table style="line-height: 15px; font-size: 12px">
                            ...
                            <tr>
                                <td style="vertical-align: top;">No SO</td>
                                <td style="vertical-align: top;">: </td>
                                <td style="vertical-align: top;"><?php echo $no_so; ?></td>
                            </tr>
                            <tr>
    ...
    <table class="word-table-no-border" style="line-height: 25px;">
       <tr> 
            <th style="text-align: left;">Total : <?php echo rupiah($final_price) ?> </th>
        </tr> 
        <tr > 
            <th style="text-align: left;">Terbilang : <?php echo ucfirst(terbilang($final_price))  ?></th>
        </tr>     
    </table>
