...
<table id="data-table-default" class="table table-hover table-bordered table-td-valign-middle">
	    ...
	    <tr><td>Photo</td><td>
	    	<a href="#modal-dialog" data-bs-toggle="modal"><img style="width: 150px;height: 150px;border-radius: 5%;" src="<?php echo base_url().'/assets/assets/img/karyawan/'.$photo ?>" /></a></td></tr>
