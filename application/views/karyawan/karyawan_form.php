	    	    ...
	    	    <?php if ($this->uri->segment(2) == 'create' || $this->uri->segment(2) == 'create_action' ) { ?>
                  ...
                  <div class="form-group">
                    <tr>
                        ...
                        <td>
                            <a href="#modal-dialog" data-bs-toggle="modal"><img  src="<?php echo base_url();?>assets/assets/img/karyawan/<?=$photo?>" style="width: 150px;height: 150px;border-radius: 5%;"></img></a>
